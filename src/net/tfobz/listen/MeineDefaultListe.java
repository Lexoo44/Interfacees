	...
	public MeinIterator elemente() {
		...
		return new MeinIterator() {
			...
			public boolean setzenAktuellesElement(Object element) {
				boolean ret = false;
				if (element != null && this.aktuellesElem.element != null) {
					this.aktuellesElem.element = (ListenElement) element;
					ret = true;
				} else {
			...
			public boolean loeschenAktuellesElement() {
				...
				if (this.aktuellesElem != null) {
					ret = true;
					if (this.hatNaechstesElement() == true) {
						this.aktuellesElem.element = null;
					} else {
						this.aktuellesElem.element = MeineDefaultListe.this.einfuegenErstesElement(null);
					}
				}
				return ret;
